...
const OBDCodePage: React.FC = () => {
  ...
  const codeSchema = {
    ...
    "@type": "WebPage",
    name: `OBD Code ${obdCode.code} - ${obdCode.description}`,
    description: `Diagnostic trouble code ${obdCode.code}: ${obdCode.description}. Find solutions and related parts.`,
  ...
  return (
    <>
      <SEO
        title={`OBD Code ${obdCode.code} - ${obdCode.description} | JP Performance Cars`}
        description={`Diagnostic trouble code ${obdCode.code}: ${obdCode.description}. Find solutions, common causes, and related parts.`}
        keywords={`OBD code ${obdCode.code}, ${obdCode.description}, diagnostic trouble code, car diagnostic, engine codes`}
